...
public class CustomersCtr {
	...
	public void newAgency(String name, int discountLevel, ArrayList<Customer> customers) {
	...
	//updates an agency
	public int updateAgency(int id, String name, int discountLevel, ArrayList<Customer> customers) {
		IFDAOAgency daoAgency = new DAOAgency();
		Agency agency = new Agency();
		agency.setID(id);
		agency.setName(name);
	...
	public int updateCustomer(int id, String CPR, String fname, String lname, String country, String ZIP, String address, String email, String password, String registrationDate, int noOfStays) {
		IFDAOCustomer daoCustomer = new DAOCustomer();
		Customer customer = new Customer();
